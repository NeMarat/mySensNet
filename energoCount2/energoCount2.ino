...
{  
  ...
  gw.sendSketchInfo("Power Meter", "2.2");
  ...
  attachInterrupt(1, check_led, FALLING); //falling voltage on pin2
...
{  
  ...
  if (v_watt_interval >= WATINTERVAL) {
    gw.send(wattMsg.set(watt, 2));
    v_watt_interval=0;
  }
